...
- ВАЖНО: Используй правильный формат таблиц: `db1.table_name` (НЕ `db1.db1.table_name`). Если в схеме указано `db1.t_partners_monetization_status`, используй именно это.
