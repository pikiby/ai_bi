...
## Назначение
Таблица `t_ai_global_report` является центральным агрегированным отчетом для AI-анализа мобильного бизнеса. Она объединяет ключевые метрики по подпискам, платежам, активным пользователям, единицам на платформе, активированным аккаунтам, новым пользователям и MAF (Monthly Active Flats) с детализацией по партнерам и городам. Отчет предназначен для предоставления комплексного ежедневного среза данных, необходимого для принятия стратегических решений и глубокой аналитики.
...
- **Сортировка:** по дате отчета (DESC) для быстрого доступа к последним данным
...
- **Комплексность:** объединение 12+ источников данных в единую структуру
